...
public class SelectorController : MonoBehaviour {
	...
	public void ModeSelection(){
		...
		switch(modoVictoria){
			case 0:
				s.transform.FindChild("TextMode").GetComponent<Text>().text = "Asesinato";
				break;
			case 1:
				s.transform.FindChild("TextMode").GetComponent<Text>().text = "Conquista";
				break;
			case 2:
				s.transform.FindChild("TextMode").GetComponent<Text>().text = "Masa";
				break;
		}
	}
}
